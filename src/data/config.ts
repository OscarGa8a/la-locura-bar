...
export const config = {
	...
	defaultOgImageAlt:
		"Imagen social de La Locura Bar, bar en Villavicencio con cerveza fría, música y fútbol",
	seoDescription:
		"Bar en Villavicencio con cervezas frías, tragos, música, fútbol en pantalla gigante y reservas por WhatsApp.",
	aiSummary:
		"La Locura Bar es un bar/pub local en Villavicencio, Meta, Colombia. Es una opción para tomar cerveza fría, pedir tragos, ver fútbol en pantalla gigante, escuchar música y reservar mesa por WhatsApp.",
	schemaType: "BarOrPub",
	priceRange: "$$",
